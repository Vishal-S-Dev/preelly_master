...
export const API_ENDPOINTS = {
  ...
  EMAIL_ATTACH: '/api/auth/email/attach',
  MOBILE_ATTACH: '/api/auth/mobile/attach',
  COMPLETE_VERIFY_EMAIL: '/api/auth/complete/verify-email',
  COMPLETE_VERIFY_PHONE: '/api/auth/complete/verify-phone',
