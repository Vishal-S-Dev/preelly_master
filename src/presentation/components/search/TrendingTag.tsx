...
export const TrendingTag = memo<Props>(({ label, selected = false, onPress }) => {
  ...
  return (
    <AnimatedPressable
      ...
      accessibilityLabel={`Trending search ${label}`}
      accessibilityState={{ selected }}
      accessibilityHint="Search for this trending keyword"
      style={[
        styles.chip,
        selected
