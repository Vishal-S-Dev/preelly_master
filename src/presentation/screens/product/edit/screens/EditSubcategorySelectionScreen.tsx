...
type Props = NativeStackScreenProps<EditProductStackParamList, 'EditProductSubcategory'>;

export const EditSubcategorySelectionScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const [selectedSubcategoryId, setSelectedSubcategoryId] = useState<string | undefined>(subcategoryId);
  ...
  }, [isStandardError, isStandardLoading, onSelectStandard, refetchStandard, standardItems, styles]);
